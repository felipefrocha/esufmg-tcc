...
\begin{frame}{Cluster orquestrador de container}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}  %%<--- here
      \begin{center}
        \begin{overprint}
          \onslide<1>\includegraphics[width=1\textwidth]{k8s-1.png}
          \onslide<2>\includegraphics[width=1\textwidth]{k8s-2.png}
          \onslide<3>\includegraphics[width=1\textwidth]{k8s-3.png}
          \onslide<4>\includegraphics[width=1\textwidth]{k8s-4.png}
          \onslide<5>\includegraphics[width=1\textwidth]{k8s-5.png}
          \onslide<6>\includegraphics[width=1\textwidth]{k8s-6.png}
          \onslide<7>\includegraphics[width=1\textwidth]{k8s-7.png}
          \onslide<8>\includegraphics[width=1\textwidth]{k8s-8.png}
          \onslide<9->\includegraphics[width=1\textwidth]{k8s-9.png}
        \end{overprint}
  ...
  \hspace*{-10mm}
    \begin{figure}
      \begin{center}
        ...
        \begin{overprint}
          \onslide<1>\includegraphics[width=1\textwidth]{seq-jupy-1.png}
          \onslide<2>\includegraphics[width=1\textwidth]{seq-jupy-2.png}
          \onslide<3>\includegraphics[width=1\textwidth]{seq-jupy-3.png}
          \onslide<4>\includegraphics[width=1\textwidth]{seq-jupy-4.png}
          \onslide<5>\includegraphics[width=1\textwidth]{seq-jupy-5.png}
          \onslide<6>\includegraphics[width=1\textwidth]{seq-jupy-6.png}
          \onslide<7>\includegraphics[width=1\textwidth]{seq-jupy-7.png}
          \onslide<8->\includegraphics[width=1\textwidth]{seq-jupy-8.png}
        \end{overprint}
      \end{center}  
...
\begin{frame}[plain]
  ...
  \begin{center}
    % \includegraphics[width=.85\paperwidth]{jupyter_sequence.png}
    \begin{overprint}
      \onslide<1>\includegraphics[width=1\textwidth]{deploy-jupy-1.png}
      \onslide<2>\includegraphics[width=1\textwidth]{deploy-jupy-2.png}
      \onslide<3>\includegraphics[width=1\textwidth]{deploy-jupy-3.png}
      \onslide<4>\includegraphics[width=1\textwidth]{deploy-jupy-4.png}
      \onslide<5>\includegraphics[width=1\textwidth]{deploy-jupy-5.png}
      \onslide<6>\includegraphics[width=1\textwidth]{deploy-jupy-6.png}
      \onslide<7>\includegraphics[width=1\textwidth]{deploy-jupy-7.png}
      \onslide<8>\includegraphics[width=1\textwidth]{deploy-jupy-8.png}
